...
def check_for_updates():
    ...
    if update_bool == 1:
        ...
        open(f"Program Name v{newest_release_url[1]}.exe", 'wb').write(newest_release_file.content) # Names the file with your program name and version number with .exe at the end
